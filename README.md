...
NOTE: if the version hasn't changed since the previous build, you'll need to delete the tag [here](https://github.com/jamiesyme/expo-cli/tags) before publishing again.
